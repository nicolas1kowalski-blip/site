...
| Tests : 96 tests d'API (PGlite et PostgreSQL, dont les constructeurs SQL, l'extraction jointe, la qualité et la qualité avancée, les tables conçues, la gouvernance, le lineage, l'exploitation, le catalogue, la surveillance, la sauvegarde et l'analyse d'impact, le cockpit, les préparations, les statistiques et l'explorateur 360°), 67 assertions de bout en bout dans Chromium | **livré** | `api/test`, `tests` |
...
| Exploitation | tableaux de bord, comparateur, séries temporelles, rapprochement, statistiques, explorateur 360° | les huit contrôles de règles sur séries (trou, saut, monotonie…) |
