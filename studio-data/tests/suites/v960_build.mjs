...
ok('version 10.0.0 dans la source et dans le fichier construit', /V11_VERSION\s*:\s*'10\.2\.3'/.test(fs.readFileSync(root+'src/10-noyau/1A-noyau-version-changelog.js','utf8')) && /V11_VERSION\s*:\s*'10\.2\.3'/.test(html));
