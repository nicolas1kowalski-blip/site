        ...
        function createSvgGraph(container) {
            ...
            const draw = () => {
                ...
                if (createSvgGraph.afterDraw) { try { createSvgGraph.afterDraw(S, S.c.querySelector('svg.usvg')); } catch (e) {} }
            };
            ...
            const bind = () => {
                ...
                svg.querySelectorAll('.usvge').forEach(g => {
                    const rec = { g, id: g.getAttribute('data-id'), s: g.getAttribute('data-s'), t: g.getAttribute('data-t'), loop: g.getAttribute('data-loop'), path: g.querySelector('path'), text: g.querySelector('text') };
                    if (!rec.s) return;
                ...
                let mode = null, dragId = null, last = null, moved = 0, sg = null; const clicks = {};
