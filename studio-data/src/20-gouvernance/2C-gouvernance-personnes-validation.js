        ...
        Studio.extend('boAttrWrite', (_w_boAttrWrite) => function (boId, stId, elId, f, v) {
        ...
        Studio.extend('updateBusinessObject', (_w_updateBusinessObject) => function (id, f, v) {
        ...
        Studio.extend('updateGlossaryTerm', (_w_updateGlossaryTerm) => function (id, f, v) {
        ...
        Studio.extend('updateTableTheme', (_w_updateTableTheme) => function (tId, v) {
        ...
        Studio.extend('updateGovAsset', (_w_updateGovAsset) => function (id, f, v) {
        ...
        Studio.extend('termTagAdd', (_w_termTagAdd) => function (kind, ctx, name) {
            name = String(name || '').trim(); if (!name) return;
        ...
        Studio.extend('termTagRemove', (_w_termTagRemove) => function (kind, ctx, termId) {
            const dom = termCtxDomain(kind, ctx);
            if (!_govBypass && govFeatureOn() && !termCtxCanEdit(kind, ctx)) {
                if (!termCtxCanPropose(kind, ctx)) return showError('Lecture seule sur ce domaine.');
        ...
        const BO_KEY_LABELS = { sources: 'sources', tables: 'tables', columns: 'colonnes', appIds: 'applications', elements: 'attributs', structure: 'facettes', references: 'références', hierarchies: 'hiérarchies', contextRules: 'règles de contexte', bizRules: 'règles métier', producedBy: 'produit par', consumedBy: 'consommé par', name: 'nom', status: 'statut', definition: 'définition', contributors: 'contributeurs', usedBy: 'utilisé par', history: 'historique' };
        ...
        function govWrapBoAction(nm, what, boIdIndex, onlyIf) {
            Studio.extend(nm, (orig) => function () {
        ...
        function govWrapAssetAction(nm, what, idIndex) {
            Studio.extend(nm, (orig) => { _govAssetOrig[nm] = orig; return function () {
        ...
        Studio.extend('updateDictColField', (_w_updateDictColField) => function (tn, col, f, v) {
        ...
        Studio.extend('updateDictField', (_w_updateDictField) => function (tn, f, v) {
            const dom = tableDomainOf(tn);
