        ...
        Studio.extend('persistAppState', (_v11_persistAppState) => function () {
        ...
        function v11SaveIndicator(st) {
            const s = el('v11Save'); if (!s) return;
        ...
        Studio.extend('renderNav', (_v11_renderNav) => function () {
        ...
        ['openBoLineage', 'openAttrLineage', 'catGoLineage', 'catShowAttrLineage'].forEach(nm => Studio.extend(nm, (o) => function () { const r = o.apply(this, arguments); try { v11FsButtons(); v11SortableTables(); } catch (e) {} return r; }, { motif: 'bouton plein écran et tri après le dessin du lineage' }));
        ...
        function v11SortTable(tb, ci, th) {
            ...
            rows.sort((a, b) => { const va = val(a), vb = val(b); const na = num(va), nb = num(vb); const r = (na !== null && nb !== null) ? na - nb : va.localeCompare(vb, 'fr', { numeric: true, sensitivity: 'base' }); return dir === 'asc' ? r : -r; });
        ...
        Studio.extend('renderGovernance', (_v11_renderGovernance) => function () {
        ...
        Studio.extend('restoreSession', (_v11_restore) => async function () { try { return await _v11_restore.apply(this, arguments); } finally { v11State.undo = []; v11State.lastGov = v11GovJson(); v11SaveIndicator('ok'); if (currentTab === 9) renderGovernance(); } });
        // ---- Démarrage ----
        (function () {
