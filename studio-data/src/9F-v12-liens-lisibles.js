        ...
        if (typeof v11Index === 'function') { const _v12lnIdx = v11Index; v11Index = function () { const items = _v12lnIdx.apply(this, arguments); try { if (Array.isArray(items)) items.push({ grp: 'Actions', ic: '⌐', label: v12LinesOn() ? 'Graphes : liens courbes (tracé d\'origine)' : 'Graphes : liens à angles droits, un couloir par lien', sub: 'lineage, carte des flux, modèle', key: 'graphe liens droits courbes couloir superposer', go: () => v12LinesSet(!v12LinesOn()) }); } catch (e) {} return items; }; }
