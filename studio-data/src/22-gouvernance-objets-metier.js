            ...
            let html = `<div class="border-2 border-emerald-200 rounded-xl bg-white overflow-hidden">
                <div class="bg-emerald-50/70 border-b border-emerald-100 p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="bo-fld"><label>Domaine métier <span class="font-normal text-slate-400">— qui valide</span></label>${govDomainSelectHtml(bo.domain || '', `updateBusinessObject('${bo.id}','domain',this.value); renderGovernance()`, 'bo-domain-' + bo.id)}${propBadgeHtml('bo', { boId: bo.id }, 'domain')}</div>
