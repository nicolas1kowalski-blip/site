        ...
        const _v12oHasMap = boAttrHasMap;
        boAttrHasMap = function (r) { return _v12oHasMap(r) || v12OrgList(r.el).length > 0; };
        const _v12oProv = boAttrProv;
        boAttrProv = function (r) { const p = _v12oProv(r); const orgs = v12OrgList(r.el); if (!orgs.length) return p; const h = orgs.map(o => v12OrgLabel(o)).join(' · '); return p ? p + ' · hérité de ' + h : 'hérité de ' + h; };
        ...
        const _v12oGraph = buildAttrLineageGraph;
        buildAttrLineageGraph = function (bo, st, e2, _depth) {
        ...
        const _v12oFlow = renderAttrFlow;
        renderAttrFlow = function (wrap) {
        ...
        const _v12oCard = attrFlowCard;
        attrFlowCard = function (fid) {
        ...
        const _v12oLin = _renderLineageImpl;
        _renderLineageImpl = function () { v12State.linOn = true; try { return _v12oLin.apply(this, arguments); } finally { v12State.linOn = false; } };
        const _v12oCsg = createSvgGraph;
        createSvgGraph = function () { const g = _v12oCsg.apply(this, arguments); if (v12State.linOn && g && typeof g.data === 'function') { const _d = g.data; g.data = function (d) { try { v12OrgLineageEdges(d); } catch (e) {} return _d.call(this, d); }; } return g; };
        // ---- fiche en lecture (V11) : la provenance héritée remplace « non alimenté » ----
        const _v12oRead = v11BoRead;
        v11BoRead = function (bo) {
